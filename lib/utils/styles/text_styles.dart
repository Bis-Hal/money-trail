...
class StringUtilsStyle {
  static TextStyle getHeadingOne({color = Colors.black, size = 32.0}) {
    return TextStyle(color: color, fontFamily: Font.bold, fontSize: size);
  }
  ...
  static TextStyle getHeadingFour({color = Colors.black, size = 20.0}) {
    return TextStyle(color: color, fontFamily: Font.semiBold, fontSize: size);
  }
  ...
  static TextStyle getHeadingEight({color = Colors.black, size = 12.0}) {
    return TextStyle(color: color, fontFamily: Font.regular, fontSize: size);
  }
  ...
  static TextStyle getCustomStyle({color, size, fontFamily = Font.regular, fontWeight}) {
    return TextStyle(
        color: color,
