        ...
        children: [
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                Padding(
                  padding: const EdgeInsets.symmetric(vertical: DimeUtil.xl, horizontal: DimeUtil.md),
                  child: Text("Add/Disable expenses",
                      style: StringUtilsStyle.getHeadingSix(color: Colors.grey[700])),
                ),
                Expanded(
                  child: Padding(
                    ...
                    child: InfiniteCarousel.builder(
                        ...
                        itemExtent: 100.0,
                        itemBuilder: (context, itemIndex, realIndex) { return Column(
                          children: [
                            FaIcon(FontAwesomeIcons.utensils, size: currentIndex== itemIndex ? 64.0 : 32.0, color: currentIndex == itemIndex? Colors.red : Colors.black,),
                            Text( currentIndex== itemIndex ? "Resturant Bill" : "")
                          ],
                        );}),
                  ),
                ),
              ...
              children: [
                ...
                ElevatedButton(
                    ...
                    child: Row(
                      ...
                      children: [
                        const FaIcon(FontAwesomeIcons.parachuteBox),
                        Padding(
                          padding:
                          ...
                          child: Text(
                            StringConstant.PAY,
                            style:
                            StringUtilsStyle.getHeadingThree(color: Colors.white),
                          ),
                        )
                      ],
                    ))
