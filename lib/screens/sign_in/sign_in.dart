            ...
            child: Column(
              ...
              children: [
                SizedBox(
                    ...
                    child: Text("Login", style: StringUtilsStyle.getCustomStyle(size: 64.0), textAlign: TextAlign.start,)),
                Form(
                  key: _formKey,
                  child: Padding(
                    padding:
                        ...
                        child: ElevatedButton(
                          onPressed: () {
                            if (_formKey.currentState!.validate()) {
                              mainController.setLoggedIn();
                              MainController.username = _username.text;
                            }
                          },
                          style: ButtonStyle(
                ...
                Row(
                  ...
                  children: [
                    Text(
                      StringConstant.SIGN_IN_QUESTION,
                      style: StringUtilsStyle.getHeadingSeven(),
                    ),
                    GestureDetector(
                      onTap: () {
